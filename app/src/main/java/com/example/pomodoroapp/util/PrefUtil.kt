...
class PrefUtil {
    companion object {
        ...
        private const val PREVIOUS_TIMER_LENGTH_SECONDS_ID = "com.example.pomodoroapp.timer.previous_timer_length"

        // previous function in case timer length is changed when previous app is running current timer is unchanged only the future timer
        ...
        private const val SECONDS_REMAINING_ID = "com.example.pomodoroapp.timer.second_remaining"
